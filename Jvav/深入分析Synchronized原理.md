...
![](/Jvav/img/syncDetail6.png)

Mark Word可能存储4种数据

在64位虚拟机下，Mark Word是64bit大小的，其存储结构如下：

![](/Jvav/img/syncDetail7.png)
...
![](/Jvav/img/syncDetail15.png)

重量级锁、轻量级锁和偏向锁之间转换

![](/Jvav/img/syncDetail16.png)
